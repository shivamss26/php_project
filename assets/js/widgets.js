...
jQuery(function ($) {
    ...
    jQuery(document).on('click', 'input.select-img', function (event) {
        ...
        magazine_elite_file_frame = wp.media.frames.magazine_elite_file_frame = wp.media({
            button: {
        ...
        magazine_elite_file_frame.on('select', function () {

            var state = magazine_elite_file_frame.state('custom-theme-insert-image');
        ...
        magazine_elite_file_frame.open();
    });
